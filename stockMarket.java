...
public class stockMarket {
    public static void main(String[] args) throws InterruptedException {
        ...
        System.out.println("    - in any input field, type 'exit' to exit the game");
        ...
        if (playOrNot.equalsIgnoreCase("q")) { // user does not want to play
                    ...
                    while (true) {
                        ...
                        if (stockSell2.equalsIgnoreCase("NVDA") || stockSell2.equalsIgnoreCase("AAPL")) {
                            ...
                            // sell AAPL
                                ...
                                System.out.printf("You don't own that many shares of %s", stockSell2);
                            }
                        }
                        else {
            ...
            if (randomEventNum >= 0.67) {
                ...
                AAPL = AAPL * 0.85;
                System.out.println("AAPL is down 15% bcoz for some reason..."); 
            }
            // add console spacing in day 2, and also add the while loop logic in day 1 
